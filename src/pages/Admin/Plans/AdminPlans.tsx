...
export const AdminPlans: React.FC = () => {
  ...
  const load = () => adminPlans.list().then(setPlans);
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      await adminPlans.update(session?.role ?? null, editingPlan.id, form);
          ...
          <Dialog.Content className={shared.dialogContent}>
            ...
            <form onSubmit={handleSave}>
              ...
              <div className={shared.dialogActions}>
                ...
                <button type="submit" className="btn-neon-orange">Lưu thay đổi</button>
              </div>
            </form>
          </Dialog.Content>
        </Dialog.Portal>
