  ...
  return (
    <section id="studio" className="relative py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative overflow-hidden border-4 border-foreground bg-card p-10 lg:p-16 shadow-[16px_16px_0_oklch(0.15_0_0)]">
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="absolute inset-0 grid place-items-center">
                <div
                  className="h-40 w-40 border-2 border-primary/30 animate-spin-slow"
              ...
              <div className="absolute bottom-4 left-4 border-2 border-foreground bg-background/70 backdrop-blur px-3 py-1.5 text-[10px] font-mono font-bold uppercase text-foreground shadow-[4px_4px_0_oklch(0.15_0_0)]">
                color · <span className="text-primary">{swatches[active].name.toLowerCase()}</span>
              </div>
            </div>
          </div>
        </div>
